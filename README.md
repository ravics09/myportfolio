...
> **Note on scope:** This is a front-end presentational site with a single serverless email API route. It intentionally has **no database, authentication, or AI features**. Sections below that don't apply are explicitly marked as _Not implemented_ so this README stays truthful to the codebase.
...
### Not Implemented
The following categories from a typical full-stack template **do not exist** in this repository:

| Category | Status |
| --- | --- |
| Authentication / Authorization | ❌ Not implemented |
| Dashboard / Admin | ❌ Not implemented |
| AI Features | ❌ Not implemented |
| Rich-text / Code Editor | ❌ Not implemented |
| Realtime Collaboration | ❌ Not implemented |
| Database / ORM | ❌ Not implemented |
| Automated Tests | ❌ Not implemented |
| Docker | ❌ Not present |
| CI/CD pipelines | ❌ Not present |
